...
public class FindIdController {
	...
	public void find_Id(RegisterRequest rr, RedirectAttributes redirectattr, Errors errors, Model model,HttpServletRequest request,HttpServletResponse response) throws AddressException, MessagingException, IOException {
